...
CONFIG_OPTIONS = [
    ...
    # ── Webhook (fire after remux) ────────────────────────────────────────
    {
        ...
        "default": False,
        "label": "Enabled",
        "description": "Send an HTTP request after a file is remuxed (e.g. to trigger a targeted Plex/Jellyfin scan via autoscan, autopulse, etc.).",
        "section": "webhook",
        "advanced": True,
    },
    {
        ...
        "default": "custom",
        "label": "Preset",
        "description": "Pick a service to pre-fill the fields below, or 'custom' to edit them yourself. The preset only changes the form; the saved values are what get used.",
        "options": ["custom", "autopulse", "autoscan (Cloudbox)", "autoscan (NiNiyas)"],
        "section": "webhook",
        "advanced": True,
    },
    {
        ...
        "default": "",
        "label": "URL",
        "description": "Target URL. Most scan tools take the file path in the query string here (e.g. ?path={path_enc} or ?dir={dir_enc}). Variables: {path}/{path_enc} (remuxed file), {dir}/{dir_enc} (folder), {filename}, {name_noext}, {old_path}/{old_path_enc}. Use the _enc variants inside a query string.",
        "section": "webhook",
        "advanced": True,
    },
    {
    ...
    {
        "key": "webhook_content_type",
        "type": "select",
        "default": "none",
        "label": "Body Type",
        "description": "'none' sends no body (the common case — the path goes in the URL query string). 'form' sends the body as form-urlencoded, 'json' as JSON.",
        "options": ["none", "form", "json"],
        "section": "webhook",
        "advanced": True,
    },
    {
        ...
        "default": "",
        "label": "Body",
        "description": "Only needed for targets that read the path from the request body (e.g. NiNiyas/autoscan's form endpoint) or custom JSON webhooks. Leave empty when the path is in the URL. Same substitution variables as the URL. Ignored when Body Type is 'none'.",
        "section": "webhook",
        "advanced": True,
    },
    {
        ...
        "default": [],
        "label": "Headers",
        "description": "Extra request headers, one per line as 'Key: Value' (e.g. an API token).",
        "placeholder": "Authorization: Bearer ...",
        "section": "webhook",
        "advanced": True,
    },
    {
        "key": "webhook_auth_user",
        "type": "string",
        "default": "",
        "label": "Basic Auth User",
        "description": "Username for HTTP Basic Auth (e.g. autopulse). Leave blank to disable.",
        "section": "webhook",
        "advanced": True,
    },
    {
    ...
    },
    {
        ...
        "default": 10,
        "label": "Timeout (s)",
        "description": "Request timeout in seconds. The call is fire-and-forget and never blocks processing.",
        "section": "webhook",
        "advanced": True,
    },
    {
        "key": "webhook_path_from",
        "type": "string",
        "default": "",
        "label": "Path Remap From",
        "description": "Optional. If ULDAS sees media under a different path than your media server, replace this leading path...",
        "section": "webhook",
        "advanced": True,
    },
    {
        ...
        "default": "",
        "label": "Path Remap To",
        "description": "...with this one, before building the {path} variables.",
        "section": "webhook",
        "advanced": True,
    },
]
